...
let yetkilialdırma = await DataBase.fetch(`YetkiliAldırma.${message.author.id}`) || 0
...
Toplam Kayıtları: **Toplam ${toplamkayıt}** (\`${erkekkayıt} erkek, ${kızkayıt} kız\`)
Toplam Ceza-i İşlemleri: **Toplam ${CmAtma+VmAtma+BanAtma+kickAtma+jailAtma} Ceza İşlemi**;
(\`ChatMute: ${CmAtma} VoiceMute: ${VmAtma} Ban: ${BanAtma} Kick: ${kickAtma} Jail: ${jailAtma}\`)

Toplam Davetleri: **Toplam ${a} davet** (\`${ayrılan} ayrılan, ${fakea} fake, ${bonus} bonus\`)
Yetkili Puanı: **${yetkilipuan} ${ayarlar.mavitac}**
Toplam Aldığı Yetkili Sayısı: **${yetkilialdırma}**
